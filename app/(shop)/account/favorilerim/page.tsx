    ...
    <div className="space-y-6">
      ...
      {favoritesProducts.length === 0 ? (
        <div className="text-center py-16 bg-warm-50 rounded-lg border-2 border-dashed border-warm-200">
          ...
          <p className="text-neutral-medium mb-6">Beğendiğiniz ürünleri kalp ikonuna tıklayarak favorilere ekleyin.</p>
          <Link href="/urunler" className="inline-block min-h-[44px]">
