        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between h-9 text-xs">
            ...
            <div className="flex items-center gap-4">
              <a href="tel:+905302084747" className="flex items-center gap-1.5 hover:text-warm-100 transition-colors">
              ...
              <a href="mailto:info@lioradg.com.tr" className="hidden sm:flex items-center gap-1.5 hover:text-warm-100 transition-colors">
                <svg className="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div className="flex items-center gap-4">
              ...
              <a href="https://instagram.com/lioradg" target="_blank" rel="noopener noreferrer" className="flex items-center gap-1 hover:text-warm-100 transition-colors">
